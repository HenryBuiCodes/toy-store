const discountEmail =  `<!doctype html>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td style="width:109px;">
                                        <img height="auto" src="http://assets.tapt.io/TaptLogo.png" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="109" />
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
                          ...
                          <tbody>
                            ...
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                <div style="font-family:Poppins, Arial, sans-serif;font-size:14px;font-style:normal;font-weight:400;line-height:26px;text-align:left;color:#262626;">Hi MJMLVAR_FIRST_NAME,</div>
                              </td>
                            </tr>
                            <tr>
                              <td align="left" style="font-size:0px;padding:10px 25px;word-break:break-word;">
                                ...
                                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;width:100%;line-height:100%;">
                                  <tr>
                                    <td align="center" bgcolor="#873CFF" role="presentation" style="border:none;border-radius:10px;cursor:auto;font-style:normal;mso-padding-alt:10px 40px;background:#873CFF;" valign="middle">
                                      <p style="display:inline-block;background:#873CFF;color:#FFFFFF;font-family:Poppins, Arial, sans-serif;font-size:16px;font-style:normal;font-weight:600;line-height:120%;margin:0;text-decoration:none;text-transform:none;padding:10px 40px;mso-padding-alt:0px;border-radius:10px;"> Discount Code </p>
                                    </td>
                                  </tr>
                                </table>
                              </td>
